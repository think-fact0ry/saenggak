...
var CACHE = 'tf-tablet-v100';   // ⚠️ 배포할 때마다 올릴 것(+index.html APP_VERSION 동기) → 켜둔 앱도 포그라운드 복귀 시 자동 갱신
var SHELL = [
  './', './index.html', './가격표.html', './검사_오감.html', './상담일지.html', './대응매뉴얼.html', './서식.html', './tfnav.js', './manifest.json',
  '/saenggak/favicon.js',
